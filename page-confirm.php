...
<?php ?>
                    ...
                    <form id="entry_form" class="form-horizontal" action="/confirm" method="post">
                        <div class="form-group">
                            <label for="fullname" class="col-sm-3 control-label">Tên của bạn</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="fullname" name="fullname" placeholder="" required autofocus>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <label class="radio-inline">
                                    <input type="radio" name="gender" checked="" value="Female">Nam
                                </label>
                                <label class="radio-inline">
...
<?php endfor; ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="telephone_number" id="telephone_number" value="" maxlength="12" class="form-control">
                            </div>
                        </div> <!-- /.form-group -->                        
                        <div class="form-group">
                            <label for="email" class="col-sm-3 control-label">E-mail</label>
                            <div class="col-sm-6">
                                <input type="email" id="email" name="email" class="form-control" value="" placeholder="" autocomplete="off">
                            </div>
                        </div> <!-- /.form-group -->
                        <div class="form-group">
                            <label for="address" class="col-sm-3 control-label">Địa chỉ</label>
                            <div class="col-sm-6">
                                <input type="text" name="address" id="address" class="form-control" value="" placeholder="" autocomplete="off">
                            </div>
                        </div> <!-- /.form-group -->
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="nationality_code" class="form-control" id="nationality_code">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="jlpt_code" class="form-control" id="jlpt_code">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="japanese_level_code" id="japanese_level_code" class="form-control">
                                    <option value="" selected="selected" class="dropdown-select option">　</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea name="entry_appeal_point" id="entry_appeal_point" class="form-control" rows="6" 
                                          placeholder="Hãy chứng tỏ bản thân để được nhà tuyển dụng lựa chọn!"></textarea>
                            </div>
                        </div> <!-- /.form-group -->                        
                        <div class="form-group">
                            <div class="col-sm-3 col-sm-offset-3">
                                <button type="submit" class="btn btn-primary btn-block btn-lg">Xác nhận nội dung</button>
                            </div>                            
                        </div> <!-- /.form-group -->
