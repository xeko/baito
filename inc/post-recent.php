...
class WP_Widget_Post_Last extends WP_Widget {
            ...
            <div class="media">
                <div class="media-left">
                    <a href="<?php echo get_permalink($recent["ID"]) ?>">
                        <?php echo get_the_post_thumbnail($recent["ID"], array(80, 80), array('class' => 'pull-left')) ?>
                    </a>
                </div>
                <div class="media-body">
                    <h4 class="media-heading"><a href="<?php echo get_permalink($recent["ID"]) ?>"><?php echo $recent["post_title"] ?></a></h4>
                    <p><small><i><?php echo get_the_time("Y-m-d", $recent["ID"]) ?></i></small></p>
                </div>
            </div>
    ...
    function form($instance) {
        $instance = wp_parse_args((array) $instance, array('title' => __('Title', 'wp-postrecent'), 'type' => 'recent_post', 'mode' => 'both', 'limit' => 5, 'disp_views' => 0));
